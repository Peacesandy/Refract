...
Start with the [Getting Started](/docs/Getting%20Started/installation) section to set up your first Refract project,
then explore the [Core Concepts](/docs/Concepts/refractions) to deepen your understanding.

...
- join the [Discord Community](/docs/Getting%20Started/quickstart) - Chat with other Refract users and contributors
- GitHub: github.com/refract-js/refract - Source code, issues, and contributions

### Read the Docs

This documentation is your go-to resource for learning Refract. It covers everything from basic concepts to advanced techniques, complete with examples and best practices.
Start with the [Getting Started](/docs/Getting%20Started/installation) section to set up your first Refract project, then explore the [Core Concepts](./Core%20Concepts/Overview) to deepen your understanding.
Happy coding with Refract! 🚀

## Next Steps

- [Installation](/docs/Getting%20Started/installation) - Learn how to set up a new Refract project from scratch.
- [Quickstart Guide](/docs/Getting%20Started/quickstart) - Follow a step-by-step tutorial to create your first Refract component.
